...
function leftToRight(board, winnerCellNumber, lastRow, lastColumn) {
  function checkWinnerLeftToRight(
    ...
    for (let i = leftBorder; i < rightBorder; i++) {
      ...
      if (numberOfSameCell === winnerCellNumber) {
        return true;
      }
    }
  }

  // checkWinnerLeftToRight(step, board, winnerCellNumber, lastRow, lastColumn)
  const hasWinner = checkWinnerLeftToRight("X", board, winnerCellNumber, 14, 7);
