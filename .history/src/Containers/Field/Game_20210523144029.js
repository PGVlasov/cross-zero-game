...
function leftTopRightBottom(
  ...
  for (let j = leftStartRowProcessed; j < rightStartRowProcessed; j++) {
    if (board[1][1] === step || board[2][2] === step || board[3][3] === step) {
      let numberOfSameCell = +1;
      console.log(numberOfSameCell);
      console.log(step);
      console.log(sboard[1][1]);
    }

    //console.log(col[j - 1]);
    // if (row[i] === step && col[i - 1] === step) {
    //   // //   numberOfSameCell += 1;
    //   // console.log(step);
    //   // console.log(row[i - 1]);
    //   //   console.log(col[i - 1]);
