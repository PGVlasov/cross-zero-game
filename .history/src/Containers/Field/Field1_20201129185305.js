...
class Field1 extends React.Component {
  ...
  onSetValue(event) {
    ...
    this.event.target.poleValue.push("X");

    console.log(event.target.poleValue.push);
  ...
  render() {
    return (
      <div className={classes.conteiner}>
        ...
        >
          <div className={classes.table} poleValue={""}></div>
          <div className={classes.table} poleValue={""}></div>
          ...
          <div className={classes.table}>6</div>
          <div className={classes.table}>8</div>
          <div className={classes.table} poleValue={""}>
            99
          </div>
          <div className={classes.table} poleValue={""}>
            100
