...
export default function Field() {
  ...
  //   console.log(this.gameField.current);

  //   gameField.addEventListener("onClick", function (event) {
  //     console.log("cliced");
  //   });
  ...
  function setCross1() {
    setState1("X");
    console.log(myRef1.current.text);
  }

  function setZero1() {
    setState1("O");
    console.log("fildValue1");
  }
