...
function checkWinner(step, board, lastRow, lastColumn) {
  ...
  return     leftToRight(board, winnerCellNumber, lastRow, lastColumn) ||
  ...
  //   function checkSquare(step) {
  //     const rowBorder = 5;
  //     const columnBorder = 5;

  //     for (let row = lastRow; row < rowBorder; row++) {}
  //     for (let column = lastColumn; column < columnBorder; column++) {}
  //   }
  function leftToRight(board, winnerCellNumber, lastRow, lastColumn) {
    const leftBorder = lastColumn - winnerCellNumber < 0 ? 0
  }
              ...
              {row.map((xOrO, columnInd) => (
                <div
                  ...
                  onClick={() => {
                    ...
                    console.log();
                    console.log("Winner? ${}");
                    const hasWinner = checkWinner(step, board, rowIndex, columnInd);
if (hasWinner) {
    // setWinner(...)
}
